...
/*CreateMsgVpnClientUsernameOK handles this case with default header values.
...
/*CreateMsgVpnClientUsernameDefault handles this case with default header values.
