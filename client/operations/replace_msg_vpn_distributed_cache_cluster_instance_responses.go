...
/*ReplaceMsgVpnDistributedCacheClusterInstanceOK handles this case with default header values.
...
/*ReplaceMsgVpnDistributedCacheClusterInstanceDefault handles this case with default header values.
