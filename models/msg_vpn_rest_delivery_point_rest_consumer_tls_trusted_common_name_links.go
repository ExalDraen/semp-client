...
func (m *MsgVpnRestDeliveryPointRestConsumerTLSTrustedCommonNameLinks) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MsgVpnRestDeliveryPointRestConsumerTLSTrustedCommonNameLinks) UnmarshalBinary(b []byte) error {
	var res MsgVpnRestDeliveryPointRestConsumerTLSTrustedCommonNameLinks
