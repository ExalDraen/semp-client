...
/*DeleteMsgVpnMqttRetainCacheOK handles this case with default header values.
...
/*DeleteMsgVpnMqttRetainCacheDefault handles this case with default header values.
