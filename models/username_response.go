...
type UsernameResponse struct {
	...
	// links
	Links *UsernameLinks `json:"links,omitempty"`
...
func (m *UsernameResponse) validateData(formats strfmt.Registry) error {
...
func (m *UsernameResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *UsernameResponse) validateMeta(formats strfmt.Registry) error {
